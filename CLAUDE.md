...
| `scripts/code2database_builder.py` | Builder CLI entry point (main command hub, 196 commands organized into 3 sub-skills: `/Code2Database` core, `/Code2Database-analysis`, `/Code2Database-ops`) |
