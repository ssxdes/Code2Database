...
| `serve` | MCP server mode (stdio, 48 tools: 30 code2database_* + 18 cgdb_*) |
...
- **MCP server**: `serve` exposes 48 tools (30 `code2database_*` + 18 `cgdb_*`); all accessible regardless of sub-skill activation
