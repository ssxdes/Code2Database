...
Start the MCP server (stdio transport, 48 tools: 30 `code2database_*` + 18 `cgdb_*`).
...
All 48 tools are accessible regardless of sub-skill activation. MCP is separate from skill layer activation. See `references/analysis_commands.md` for the 18 `cgdb_*` tools; see parent `references/usage_reference.md` for the 30 `code2database_*` tools.
