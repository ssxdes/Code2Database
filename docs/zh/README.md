...
[![MCP工具](https://img.shields.io/badge/MCP工具-48-blueviolet)](#mcp-服务器)
[![查询命令](https://img.shields.io/badge/查询命令-122-success)](#命令参考)
...
| **MCP 服务器** | `serve` — 通过 stdio 暴露 48 个查询工具（30 code2database_* + 18 cgdb_*）供 LLM 代理使用 |
...
| **MCP 服务器** | stdio 传输，**48 个查询工具**（30 code2database_* + 18 cgdb_*）供 LLM 代理使用 |
...
| 命令 | 说明 |
|------|------|
| `serve` | 启动 MCP 服务器（stdio 传输，48 工具：30 code2database_* + 18 cgdb_*） |
