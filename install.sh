...
if ! command -v python3 &>/dev/null; then
    die "python3 not found. Please install Python 3.10+ first."
fi
...
for doc_file in RUNTIME_CONFIG.md PROFILE_MANUAL.md DEPLOYMENT.md TROUBLESHOOTING.md; do
...
ok "RUNTIME_CONFIG.md + PROFILE_MANUAL.md + DEPLOYMENT.md + TROUBLESHOOTING.md [core]"
