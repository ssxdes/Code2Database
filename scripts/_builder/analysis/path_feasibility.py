...
Usage:
    from _builder.analysis.path_feasibility import solve_path_feasibility
...
def check_config_feasible(config_predicates: List[str],
    ...
    try:
        from _builder.cgdb.cgdb_config_predicates import evaluate_predicate
    except ImportError:
...
def cmd_path_feasible(args):
    ...
    if getattr(args, "conditions", ""):
        ...
        try:
            from _builder.ops.runtime_guards import check_runtime_guards_with_profile
            if conds:
