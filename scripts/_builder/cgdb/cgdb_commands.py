...
def cmd_cgdb_schema_version(args):
    ...
    try:
        ...
        from _builder.cgdb.cgdb_migrations import MIGRATIONS
    except ImportError:
...
def cmd_cgdb_path(args):
    ...
    try:
        ...
        if src_id is None or dst_id is None:
            ...
            try:
                from _builder.misc.coverage_report import path_not_found_hints
...
def cmd_cgdb_path_feasible(args):
    ...
    try:
        ...
        if with_configs:
            try:
                from _builder.analysis.path_feasibility import (
...
def cmd_cgdb_coverage(args):
    ...
    """
    from _builder.misc.coverage_report import query_coverage
