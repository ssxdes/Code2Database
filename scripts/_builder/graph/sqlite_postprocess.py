...
def _build_callgraph_summary_md_from_sqlite(db_path, outdir, source_root="", build_info=None):
    ...
    with _open_db(db_path) as conn:
        ...
        cgdb_tables = [
            ("layer 0", "graph_versions", "graph_versions"),
            ("layer 1", "cgdb_nodes", "cgdb_nodes"),
            ("layer 1", "cgdb_edges", "cgdb_edges"),
            ("layer 1", "cgdb_files", "cgdb_files"),
            ("layer 2", "cgdb_types", "cgdb_types"),
            ("layer 3", "conditions", "conditions"),
            ("layer 3.5", "config_predicates", "config_predicates"),
            ("layer 4", "basic_blocks", "basic_blocks"),
            ("layer 4", "cfg_edges", "cfg_edges"),
            ("layer 5", "data_flow", "data_flow"),
            ("layer 6", "alias_sets", "alias_sets"),
            ("layer 7", "sync_primitives", "sync_primitives"),
            ("layer 7", "happens_before", "happens_before"),
            ("layer 8", "ops_bindings", "ops_bindings"),
            ("layer 9", "doc_comments", "doc_comments"),
            ("layer 10", "cgdb_includes", "cgdb_includes"),
            ("layer 11", "invoke_sites", "invoke_sites"),
        ]
        cgdb_rows = []
        has_any_cgdb = False
...
def _build_architecture_flows_from_sqlite(db_path, outdir, source_root="", build_info=None):
    ...
    with _open_db(db_path) as conn:
        ...
        try:
            from _builder.build.auto_enhance import _BUILTIN_METHOD_NAMES as _BUILTINS_SET
        except Exception:
