...
class TestPredicates(unittest.TestCase):
    ...
    def test_is_metavar_basic(self):
        from _builder.misc.ast_pattern import _is_metavar
    ...
    def test_is_deep_metavar(self):
        from _builder.misc.ast_pattern import _is_deep_metavar
    ...
    def test_is_ellipsis(self):
        from _builder.misc.ast_pattern import _is_ellipsis
...
class TestTokenizePattern(unittest.TestCase):
    ...
    def test_simple_pattern(self):
        from _builder.misc.ast_pattern import _tokenize_pattern
...
class TestTokenizeSource(unittest.TestCase):
    ...
    def test_identifiers_and_punctuation(self):
        from _builder.misc.ast_pattern import _tokenize_source
...
class TestMatchTokens(unittest.TestCase):
    ...
    def test_exact_literal_match(self):
        from _builder.misc.ast_pattern import _tokenize_pattern, _tokenize_source, _match_tokens
    ...
    def test_empty_pattern_matches_empty_source(self):
        from _builder.misc.ast_pattern import _match_tokens
